...
## 🔗 Related Project — Health Score

A global, centralized medical history system for verified medical records (vaccine history, appointment history) aggregated from health centers worldwide. Users upload data locally; the system connects to verified institutions to validate authenticity. Authorized parties can access verified records easily.

- Demo video: https://drive.google.com/file/d/1nlgGOIWDt67UwUe5QVRyIRQwbUlaMb87/view?usp=sharing

<details>
<summary>Master (Deprecated)</summary>
...
<details>
<summary>Develop (Deprecated)</summary>
